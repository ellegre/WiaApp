...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:wialon.67a8bade7436.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){
  ...
  var a = "unit/update_sensor",b = "resource/update_poi",c = "resourceZoneGroups",d = "unitSensors",f = "adminField",g = "itemProfileFields",h = "resource/update_drivers_group",l = "render",m = "u",n = "order/update",o = "zonesGroup",p = "item/delete_item",q = "singleton",r = "resourcePois",s = "ftp",t = "item/update_admin_field",u = "&svc=file/get&params=",v = "script",w = "serverUpdated",x = "core/check_items_billing",y = "resource/get_job_data",z = "qx.event.type.Event",A = "//",B = "item/update_profile_field",C = "resource/get_poi_data",D = "ujb",E = "token/login",F = "token/update",G = "file/list",H = "//geocode-maps.wialon.com/",I = "report",J = "unitFuelSettings",K = "local",L = "route/get_round_data",M = "tags",N = "flds",O = "core/get_hw_types",P = "userNotification",Q = "si",R = "order_routes",S = "core/search_item",T = "profileField",U = "=",V = 'u',W = "core/create_resource",X = "core/create_user",Y = "?sid=",fa = "number",eV = "firmware",fb = "customField",eW = "core/create_unit",eX = "; ",eU = "usnf",eY = "unitCommandDefinitions",fg = "resource/update_tag",fh = "token/list",fn = "routeSchedules",fi = "core/login",fc = "route/update_round",fd = "string",fe = "//routing-maps.wialon.com/",ff = "core/create_auth_hash",fm = "__dd",fQ = "poi",fo = "ud",fp = "core/update_data_flags",fj = "serviceInterval",fk = "core/create_retranslator",gR = "resourceReports",fl = "core/reset_password_perform",fq = "core/create_route",fr = "unitReportSettings",fs = "sensor",fx = "qx.event.type.Data",fy = "search",fz = "//search-maps.wialon.com/",ft = "resource/update_zone",fu = "/avl_evts",fv = "rr",fw = "round",fE = "zone",fF = "core/create_unit_group",fG = "unf",fH = "item/update_ftp_property",fA = "aflds",fB = "mapps",fC = "core/get_account_data",fD = "//render-maps.wialon.com/",fL = "fileUploaded",fM = "resourceDrivers",ha = "commandDefinition",fN = "unitServiceIntervals",fI = "resource/update_zones_group",fJ = "function",gX = "tagsgr",fK = "rep",fO = "report/update_report",fP = "resource/update_job",gc = "rs",gb = "zl",ga = "wialon.js",gg = "en",gf = "itemCreated",ge = "unitEventRegistrar",gd = "orders",fU = 'undefined',fT = "user/update_user_notification",fS = "[\\?&]callback=([^&#]*)",fR = "d",fY = "geocode",fX = "trlrs",fW = "user/send_sms",fV = "core/get_hw_cmds",gn = "file/read",gm = "route/update_schedule",gl = "account/get_account_data",gk = "/wialon/ajax.html",gr = "lang",gq = "m",gp = "resource/update_trailers_group",go = "report/get_report_tables",gj = "resourceAccounts",gi = "resourceTags",gh = "trailer",gC = "account/list_change_accounts",gB = "notification",gA = "unit/update_command_definition",gG = "itemIcon",gF = "order/route_update",gE = "schedule",gD = "col",gv = "drvrs",gu = "1.51",gt = "file/library",gs = "statsFinished",gz = "itemFtpProps",gy = "__dc",gx = "core/search_items",gw = "core/duplicate",gM = "trlrsgr",gL = "FtpProp",gK = "trailersGroup",gJ = "mobileApp",gQ = "object",gP = "sensu",gO = "resource/update_notification",gN = "unitDriveRankSettings",gI = "tag",gH = "__cY",em = "orderRoute",el = "wialon.core.Session",hb = "featuresUpdated",ej = "item/update_custom_field",ek = "unit/update_service_interval",ei = "invalidSession",gY = "drvrsgr",eg = "resourceJobs",eh = "core/use_auth_hash",ef = "resourceTrailers",gV = "routeRounds",ed = "resourceTrailerGroups",ee = "core/logout",ec = "driversGroup",ev = "__cV",ew = "core/set_session_property",et = "resourceNotifications",eu = "resource/update_tags_group",er = "order",es = "job",eq = "resource/update_trailer",eb = "core/check_accessors",eo = "core/reset_password_request",ep = "resource/get_notification_data",en = "itemAdminFields",eJ = "report/get_report_data",eH = "unitMessagesFilter",eI = "cml",eF = "/",eG = "&svc=core/export_file&params=",eE = "tagsGroup",gU = "unitTripDetector",eC = "itemDeleted",eD = "",eB = "resource/get_zone_data",gW = "resourceZones",ez = "mobileApps",eA = "userNotifications",ex = "resourceOrders",ey = "sens",eR = "Can't parse avl_evts json, possible wrong chars in responce. Data is ignored.",eS = "resource/update_driver",eP = "driver",eQ = "itemCustomFields",eN = "unitEvents",eO = "routing",eM = "resourceDriverGroups",gS = "pflds",eK = "user/update_mobile_app",eL = "undefined",eT = "zg";
  qx.Class.define(el, {
    extend : qx.core.Object,
    type : q,
    construct : function(){
    ...
    members : {
      ...
      __wH : null,
      __wJ : null,
      initSession : function(he, hd, hc, hh, hf, hi){
        ...
        this.__de = he;
        this.__wD = he;
        if(typeof hd != eL)this.__dg = hd;
        if(typeof hc != eL && !isNaN(parseInt(hc))){

          var hg = parseInt(hc);
          if(hg & 0x800)this.__df = true;
        };
        if(typeof hh != eL)this.__di = hh;
        ...
        if(hi){
          ...
          if(hi.apiPath)this.__wE = hi.apiPath;
          if(hi.gisUrl)this.__wD = hi.gisUrl;
          this.__wF = !!hi.ignoreBaseUrl;
          this.__wG = !!hi.whiteLabel;
          this.__wH = hi.logger;
          this.__wJ = hi.loginSiteName;
        };
        return true;
      },
      ...
      login : function(hn, hl, hm, hk){

        hk = wialon.util.Helper.wrapCallback(hk);
        ...
        }, qx.lang.Function.bind(this.__dw, this, hk));
      },
      loginAuthHash : function(hs, hr, hp){

        var ho = eD;
        if(hr && typeof hr == fJ)hp = hr; else if(hr && typeof hr == fd)ho = hr;;
        ...
        if(this.__wJ)hq.siteName = this.__wJ;
        return wialon.core.Remote.getInstance().remoteCall(eh, hq, qx.lang.Function.bind(this.__dw, this, hp));
      },
      loginToken : function(hv, hx, hu){

        var ht = eD;
        if(hx && typeof hx == fJ)hu = hx; else if(hx && typeof hx == fd)ht = hx;;
        hu = wialon.util.Helper.wrapCallback(hu);
        if(this.__cV || !this.__cS){
        ...
        if(this.__wJ)hw.siteName = this.__wJ;
        return wialon.core.Remote.getInstance().remoteCall(E, hw, qx.lang.Function.bind(this.__dw, this, hu));
      },
      duplicate : function(hD, hA, hy, hC, hz){

        var hB = 0;
        if(hz)hB = 1;
        hC = wialon.util.Helper.wrapCallback(hC);
        if(this.__cV || !this.__cS){
        ...
        return wialon.core.Remote.getInstance().remoteCall(gw, {
          operateAs : hA,
          continueCurrentSession : hy,
          checkService : this.__di,
          restore : hB,
          appName : this.__dg
        }, qx.lang.Function.bind(this.__dw, this, hC));
      },
      logout : function(hE){
        ...
        return wialon.core.Remote.getInstance().remoteCall(ee, null, qx.lang.Function.bind(function(hF, hG){
      ...
      updateSessionProperty : function(hJ, hI){

        return wialon.core.Remote.getInstance().remoteCall(ew, {
          prop_name : hJ.propName,
          prop_value : hJ.propValue
        }, wialon.util.Helper.wrapCallback(hI));
      },
      updateToken : function(hK, hL, hM){
        ...
        return wialon.core.Remote.getInstance().remoteCall(F, {
          ...
          p : hL.p,
          items : hL.items,
          deleteAll : hL.deleteAll,
          userId : hL.userId
        }, hM);
      },
      listTokens : function(hO, hN){

        return wialon.core.Remote.getInstance().remoteCall(fh, {
          app : hO.app,
          userId : hO.userId
        }, wialon.util.Helper.wrapCallback(hN));
      },
      updateDataFlags : function(hQ, hP){

        hP = wialon.util.Helper.wrapCallback(hP);
        if(!this.__cV || typeof hQ != gQ){
        ...
        return wialon.core.Remote.getInstance().remoteCall(fp, {
          spec : hQ
        }, qx.lang.Function.bind(this.__dx, this, hP));
      },
      searchItems : function(hV, hU, hR, hT, hS, hW, hX){

        hW = wialon.util.Helper.wrapCallback(hW);
        if(!this.__cV || typeof hV != gQ){

          hW(2, null);
          return;
        };
        return wialon.core.Remote.getInstance().remoteCall(gx, {
          spec : hV,
          force : hU ? 1 : 0,
          flags : hR,
          from : hT,
          to : hS
        }, qx.lang.Function.bind(this.__dy, this, hW), hX);
      },
      searchItem : function(ib, hY, ia){
        ...
        return wialon.core.Remote.getInstance().remoteCall(S, {
          id : ib,
          flags : hY
        }, qx.lang.Function.bind(this.__dz, this, ia));
      },
      loadLibrary : function(ic){

        if(typeof this._libraries[ic] != eL)return true;
        if(ic == eA)wialon.item.PluginsManager.bindPropItem(wialon.item.User, eU, P, fT); else if(ic == eQ)wialon.item.PluginsManager.bindPropItem(wialon.item.Item, N, fb, ej); else if(ic == gz)wialon.item.PluginsManager.bindPropItem(wialon.item.Item, s, gL, fH); else if(ic == en)wialon.item.PluginsManager.bindPropItem(wialon.item.Item, fA, f, t); else if(ic == g)wialon.item.PluginsManager.bindPropItem(wialon.item.Item, gS, T, B); else if(ic == gG){

          qx.Class.include(wialon.item.Unit, wialon.item.MIcon);
          qx.Class.include(wialon.item.UnitGroup, wialon.item.MIcon);
        } else if(ic == eY)wialon.item.PluginsManager.bindPropItem(wialon.item.Unit, eI, ha, gA); else if(ic == d){

          wialon.item.PluginsManager.bindPropItem(wialon.item.Unit, ey, fs, a);
          qx.Class.include(wialon.item.Unit, wialon.item.MUnitSensor);
        } else if(ic == fN)wialon.item.PluginsManager.bindPropItem(wialon.item.Unit, Q, fj, ek); else if(ic == gU)qx.Class.include(wialon.item.Unit, wialon.item.MUnitTripDetector); else if(ic == eH)qx.Class.include(wialon.item.Unit, wialon.item.MUnitMessagesFilter); else if(ic == ge)qx.Class.include(wialon.item.Unit, wialon.item.MUnitEventRegistrar); else if(ic == fr)qx.Class.include(wialon.item.Unit, wialon.item.MUnitReportSettings); else if(ic == gN)qx.Class.include(wialon.item.Unit, wialon.item.MUnitDriveRankSettings); else if(ic == J)qx.Class.include(wialon.item.Unit, wialon.item.MUnitFuelSettings); else if(ic == et)wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, fG, gB, gO, ep); else if(ic == eg)wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, D, es, fP, y); else if(ic == gW){

          qx.Class.include(wialon.item.Resource, wialon.item.MZone);
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, gb, fE, ft, eB);
        } else if(ic == c){

          qx.Class.include(wialon.item.Resource, wialon.item.MZone);
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, eT, o, fI);
        } else if(ic == r){

          qx.Class.include(wialon.item.Resource, wialon.item.MPoi);
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, fQ, fQ, b, C);
        } else if(ic == fM){

          qx.Class.include(wialon.item.Resource, wialon.item.MDriver);
          wialon.item.MDriver.registerDriverProperties();
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, gv, eP, eS);
        } else if(ic == eM){

          qx.Class.include(wialon.item.Resource, wialon.item.MDriver);
          wialon.item.MDriver.registerDriverProperties();
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, gY, ec, h);
        } else if(ic == ef){

          qx.Class.include(wialon.item.Resource, wialon.item.MDriver);
          wialon.item.MDriver.registerDriverProperties();
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, fX, gh, eq);
        } else if(ic == ed){

          qx.Class.include(wialon.item.Resource, wialon.item.MDriver);
          wialon.item.MDriver.registerDriverProperties();
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, gM, gK, gp);
        } else if(ic == gj)qx.Class.include(wialon.item.Resource, wialon.item.MAccount); else if(ic == gR){

          qx.Class.include(wialon.item.Resource, wialon.item.MReport);
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, fK, I, fO, eJ);
        } else if(ic == gV)wialon.item.PluginsManager.bindPropItem(wialon.item.Route, fv, fw, fc, L); else if(ic == fn)wialon.item.PluginsManager.bindPropItem(wialon.item.Route, gc, gE, gm); else if(ic == eN)qx.Class.include(wialon.item.Unit, wialon.item.MUnitEvents); else if(ic == ez)wialon.item.PluginsManager.bindPropItem(wialon.item.User, fB, gJ, eK); else if(ic == ex){

          qx.Class.include(wialon.item.Resource, wialon.item.MOrder);
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, gd, er, n);
          qx.Class.include(wialon.item.Resource, wialon.item.MOrderRoute);
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, R, em, gF);
        } else if(ic == gi){

          qx.Class.include(wialon.item.Resource, wialon.item.MTag);
          wialon.item.MTag.registerTagProperties();
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, M, gI, fg);
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, gX, eE, eu);
        } else return false;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        this._libraries[ic] = 1;
        return true;
      },
      getHwTypes : function(ig, ie){

        var ih = {
        };
        if(ig && typeof ig == fJ)ie = ig; else if(ig && typeof ig == gQ)ih = ig;;
        if(!this.__cV){
        ...
        return wialon.core.Remote.getInstance().remoteCall(O, {
          filterType : ih.filterType,
          filterValue : ih.filterValue,
          includeType : ih.includeType
        }, wialon.util.Helper.wrapCallback(ie));
      },
      getHwCommands : function(ii, ij, ik){
      ...
      getHwCommandTemplates : function(io, il){
        ...
        if(io && typeof io == gQ){
          ...
          im.deviceTypeId = arguments[0];
          im.unitId = arguments[1];
          im.lang = gg;
          il = wialon.util.Helper.wrapCallback(arguments[2]);
        };
        if(!this.__cV){
        ...
        return wialon.core.Remote.getInstance().remoteCall(fV, {
          deviceTypeId : im.deviceTypeId,
          unitId : im.unitId,
          template : 1,
          lang : im.lang
        }, il);
      },
      createUnit : function(is, name, iq, ip, ir){
        ...
        return wialon.core.Remote.getInstance().remoteCall(eW, {
          ...
          hwTypeId : iq,
          dataFlags : ip
        }, qx.lang.Function.bind(this.__dz, this, ir));
      },
      createUser : function(iw, name, iv, it, iu){
        ...
        return wialon.core.Remote.getInstance().remoteCall(X, {
          ...
          password : iv,
          dataFlags : it
        }, qx.lang.Function.bind(this.__dz, this, iu));
      },
      createUnitGroup : function(iz, name, ix, iy){
      ...
      createRetranslator : function(iD, name, iC, iA, iB){
        ...
        return wialon.core.Remote.getInstance().remoteCall(fk, {
          ...
          config : iC,
          dataFlags : iA
        }, qx.lang.Function.bind(this.__dz, this, iB));
      },
      createRoute : function(iG, name, iE, iF){
      ...
      createResource : function(iK, name, iH, iJ, iI){
        ...
        return wialon.core.Remote.getInstance().remoteCall(W, {
          ...
          skipCreatorCheck : iJ,
          dataFlags : iH
        }, qx.lang.Function.bind(this.__dz, this, iI));
      },
      deleteItem : function(iL, iM){

        iM = wialon.util.Helper.wrapCallback(iM);
        return wialon.core.Remote.getInstance().remoteCall(p, {
          itemId : iL.getId()
        }, qx.lang.Function.bind(this.__dA, this, iM, iL.getId()));
      },
      updateItem : function(iO, iP){
        ...
        if(iP.tp === fo){
          ...
          if(iP.pos){
            ...
            if(typeof iP.pos.t === eL)iP.pos.t = iP.t;
            if(typeof iP.pos.f === eL)iP.pos.f = iP.f;
            if(typeof iP.pos.lc === eL)iP.pos.lc = iP.lc;
          };
        };
        for(var iN in iP){

          switch(iN){case ey:case gP:
          continue;};
          iQ.call(this, iN);
        };
        if(Object.prototype.hasOwnProperty.call(iP, ey))iQ.call(this, ey);
        if(Object.prototype.hasOwnProperty.call(iP, gP))iQ.call(this, gP);
        function iQ(iR){
      ...
      getIconsLibrary : function(iT, iV, iW){

        var iU = 0;
        if(typeof iW != eL)iU = iV; else iW = iV;
        wialon.core.Remote.getInstance().remoteCall(gt, {
          type : iT,
          flags : iU
        }, wialon.util.Helper.wrapCallback(iW));
      },
      getFirmwareLibrary : function(iY, iX){
        ...
        wialon.core.Remote.getInstance().remoteCall(G, {
          ...
          recursive : true,
          fullPath : true
        }, wialon.util.Helper.wrapCallback(iX));
      },
      getLibraryFile : function(ja){
        ...
        return wialon.core.Session.getInstance().getBaseUrl() + this.__wE + Y + wialon.core.Session.getInstance().getId() + u + wialon.util.Json.stringify(jb);
      },
      readLibraryFile : function(jc, jd){

        wialon.core.Remote.getInstance().remoteCall(gn, {
          itemId : 0,
          storageType : 1,
          path : jc
        }, wialon.util.Helper.wrapCallback(jd));
      },
      resetPasswordRequest : function(jl, jk, jh, jj, jg){
        ...
        var jf = document.cookie.split(eX);
        var je = gg;
        for(var i = 0;i < jf.length;i++){

          var ji = jf[i].split(U);
          if(ji.length == 2 && ji[0] == gr){
      ...
      resetPasswordPerform : function(jo, jn, jm){
      ...
      sendSms : function(jq, jr, jp){

        return wialon.core.Remote.getInstance().remoteCall(fW, {
          phoneNumber : jq,
          smsText : jr
        }, wialon.util.Helper.wrapCallback(jp));
      },
      getAccountData : function(jt, js){

        return wialon.core.Remote.getInstance().remoteCall(fC, {
          type : jt ? 2 : 1
        }, wialon.util.Helper.wrapCallback(js));
      },
      getAccountsData : function(jv, jw, ju){
      ...
      checkItemsBilling : function(jx, jy, jz, jA){

        return wialon.core.Remote.getInstance().remoteCall(x, {
          items : jx,
          serviceName : jy,
          accessFlags : jz
        }, wialon.util.Helper.wrapCallback(jA));
      },
      checkAccessors : function(jC, jB){

        return wialon.core.Remote.getInstance().remoteCall(eb, jC, wialon.util.Helper.wrapCallback(jB));
      },
      listChangeAccount : function(jE, jD){

        return wialon.core.Remote.getInstance().remoteCall(gC, {
          dataFlags : jE.dataFlags,
          units : jE.units
        }, wialon.util.Helper.wrapCallback(jD));
      },
      getReportTables : function(jF){

        return wialon.core.Remote.getInstance().remoteCall(go, {
        }, wialon.util.Helper.wrapCallback(jF));
      },
      setLoginHash : function(jG){

        this.__dh = jG;
      },
      getExportListUrl : function(jI){

        var jH = qx.lang.Object.clone(jI);
        return wialon.core.Session.getInstance().getBaseUrl() + this.__wE + Y + wialon.core.Session.getInstance().getId() + eG + encodeURIComponent(wialon.util.Json.stringify(jH));
      },
      ...
      getItem : function(jJ){
        ...
        var jK = this.__cY[parseInt(jJ)];
        if(typeof jK != fU)return jK;
        return null;
      },
      getItems : function(jN){

        if(!this.__cY || !this.__da)return null;
        if(typeof jN == eL || jN == eD){

          var jM = new Array;
          for(var jL in this.__cY)jM.push(this.__cY[jL]);
          return jM;
        } else {

          var jO = this.__da[jN];
          if(typeof jO != eL)return jO;
        };
        return (new Array);
      },
      registerConstructor : function(jP, jQ){

        if(typeof this.__cR[jP] != eL)return;
        this.__cR[jP] = jQ;
      },
      registerProperty : function(jR, jS){

        if(typeof this.__cQ[jR] != eL)return;
        this.__cQ[jR] = jS;
      },
      getBaseUrl : function(){
      ...
      setEvtPollInterval : function(jU){
        ...
        if(this.__cU !== jU){
          ...
          if(this.__wx){
            ...
            if(jW >= jU * 1000){
              ...
              var jV = jU * 1000 - jW;
              if(jV < 0)jV = 0;
              this.__wx = qx.lang.Function.delay(this.__dq, jV, this);
            };
          };
        };
      },
      getBaseGisUrl : function(jX){

        if(!this.__df && this.__wD != eD){

          var jY = this.__wD.split(A);
          if(jY.length >= 2){

            if(jX == l)return jY[0] + fD + jY[1]; else if(jX == fy)return jY[0] + fz + jY[1]; else if(jX == fY)return jY[0] + H + jY[1]; else if(jX == eO)return jY[0] + fe + jY[1];;;;
          };
        };
        return this.__wD;
      },
      ...
      checkFeature : function(ka){

        if(!this.__dk || typeof this.__dk.svcs == eL)return 0;
        if(typeof this.__dk.svcs[ka] == eL){

          if(this.__dk.unlim == 1)return 1;
          return 0;
        };
        var kb = this.__dk.svcs[ka];
        if(kb == 1)return 1; else if(kb == 0)return -1;;
        return 0;
      },
      __dq : function(){
        ...
        this.__wx = null;
        this.__wy = Date.now();
        if(!this.__cT || !this.__cU || typeof wialon === eL)return;
        wialon.core.Remote.getInstance().ajaxRequest(fu, {
          sid : this.__cT
        }, qx.lang.Function.bind(this.__dr, this, this.__cT), 60);
      },
      __dr : function(ki, kd, kh){

        if(kd != 0){

          if(kd == 1){

            if(this.__ds(ki))this.fireEvent(ei);
          } else if(this.__cU){
        ...
        this.__cW = kh.tm;
        for(var i = 0;i < kh.events.length;i++){

          var kj = kh.events[i];
          if(kj.i > 0){

            var kg = this.getItem(kj.i);
            if(kg && typeof kg != eL){

              if(kj.t == m)this.updateItem(kg, kj.d); else if(kj.t == gq)kg.handleMessage(kj.d); else if(kj.t == fR)this._onItemDeleted(kg);;;
            } else {

              if(kj && (typeof kj.i === fa) && (kj.t === V)){

                var kf = this.__dj[kj.i];
                if(!kf){
          ...
          } else if(kj.i == -1)this.fireDataEvent(fL, kj.d, null); else if(kj.i == -2){
            ...
            this.fireDataEvent(gs, kj.d, null);
          } else if(kj.i == -5){

            var kk = kj.d;
            if(typeof kk.r != eL && kk.r.length){

              for(var j = 0;j < kk.r.length;j++){

                var kg = this.getItem(kk.r[j]);
                if(kg)this._onItemDeleted(kg);
              };
            };
            if(typeof kk.a != eL && kk.a.length){

              var ke = [];
              for(var j = 0;j < kk.a.length;j++){

                var kl = kk.a[j].ids;
                for(var k = 0;k < kl.length;k++){

                  var kc = kl[k];
                  var kg = this.getItem(kc);
                  if(!kg)ke.push(kc);
                };
              };
              if(ke.length){
      ...
      checkNewItems : function(kp, km){

        var kq = kp.ids,kn = kp.updateDataFlagsSpec;
        var ko = wialon.core.Session.getInstance();
        kq = kq.filter(qx.lang.Function.bind(function(kr){

          if(this.__wA[kr])return false;
          if(this.getItem(kr))return false;
          this.__wA[kr] = true;
          return true;
        }, this));
        if(!kn){
        ...
        this.updateDataFlags(kn, qx.lang.Function.bind(function(kt){

          kq.forEach(qx.lang.Function.bind(function(ku){

            delete this.__wA[ku];
          }, this));
          if(kt){

            if(typeof km === fJ)km(kt);
            return;
          };
          var ks = [];
          kq.forEach(qx.lang.Function.bind(function(kw){

            var kv = this.getItem(kw);
            if(!kv)return;
            ks.push(kv);
          }, this));
          this.fireDataEvent(gf, ks, null);
          if(typeof km === fJ)km(null);
        }, this));
      },
      parseSessionData : function(ky){

        if(!ky || this.__cV)return false;
        this.__cT = ky.eid;
        this.__cU = 2;
        this.__cW = ky.tm;
        this.__db = ky.au;
        this.__fE = (ky.api && ky.api.indexOf(K) >= 0) ? 1 : 0;
        if(ky.wsdk_version)this.__dn = ky.wsdk_version;
        if(ky.hl)this.__dp = ky.hl;
        this.__cX = {
        };
        for(var kx in ky.classes)this.__cX[ky.classes[kx]] = kx;
        this.__cY = {
        };
        this.__da = {
        };
        this.__cV = this.__dt(ky.user, wialon.item.User.defaultDataFlags());
        this.__du(this.__cV);
        if(ky.token){

          try{

            this.__do = wialon.util.Json.parse(ky.token);
            if(ky.th)this.__do.th = ky.th;
        ...
        if(typeof ky.features != eL)this.__dk = ky.features;
        if(typeof ky.base_url != eL && ky.base_url != eD && ky.base_url != this.getBaseUrl()){

          this.__wD = ky.base_url;
          if(!this.__wF){

            this.setBaseUrl(ky.base_url);
          };
        };
        this.__wu = ky.hw_gw_ip || eD;
        this.__wK = ky.hw_gw_dns || eD;
        if(typeof ky.env != eL && ky.env)this.__wB = ky.env;
        if(this.__cU){
      ...
      __ds : function(kz){
        ...
        if(kz && kz != this.__cT)return false;
        this.__cS = 0;
        this.__cT = eD;
        this.__cV = null;
        this.__cW;
      ...
      __dt : function(kD, kC){
        ...
        if(!kD || !kC)return null;
        kD.tp = this.__cX[kD.cls];
        if(typeof kD.tp == eL)return null;
        var kB;
        var kE = this.__cR[kD.tp];
        if(typeof kE == eL)return null;
        kB = new kE(kD, kC);
        this.updateItem(kB, kD);
        var kA = kB && this.__dj[kB.getId()];
        if(kA){

          delete this.__dj[kB.getId()];
          kA.forEach(qx.lang.Function.bind(function(kF){

            this.updateItem(kB, kF.d);
          }, this));
        };
        return kB;
      },
      __du : function(kG){
        ...
        if(!kG || !this.__cY)return;
        this.__cY[kG.getId()] = kG;
        var kH = this.__da[kG.getType()];
        if(typeof kH == eL){

          this.__da[kG.getType()] = new Array;
          kH = this.__da[kG.getType()];
        };
        kH.push(kG);
      },
      __dv : function(kI){
        ...
        if(!kI)return;
        if(typeof this.__cY[kI.getId()] != eL)delete this.__cY[kI.getId()];
        var kJ = this.__da[kI.getType()];
        if(typeof kJ != eL)qx.lang.Array.remove(kJ, kI);
        kI.dispose();
      },
      _onItemDeleted : function(kK){

        if(!kK)return;
        kK.fireEvent(eC);
        this.__dv(kK);
      },
      __dw : function(kL, kM, kN){
        ...
        if(this.parseSessionData(kN))kL(0); else kL(6);
      },
      __dx : function(kR, kP, kU){
        ...
        for(var i = 0;i < kU.length;i++){
          ...
          var kQ = kU[i].d;
          var kT = this.__cY[kO];
          if(typeof kT == eL && kS != 0 && kQ){

            var kT = this.__dt(kQ, kS);
            if(kT)this.__du(kT);
          } else {

            if(kS == 0)this.__dv(kT); else {

              if(typeof kT == eL)return;
              if(kQ)this.updateItem(kT, kQ);
              kT.setDataFlags(kS);
            };
          };
          kQ = null;
      ...
      __dy : function(kW, kV, la){
        ...
        var kX = {
          searchSpec : la.searchSpec,
          dataFlags : la.dataFlags,
          totalItemsCount : la.totalItemsCount,
          indexFrom : la.indexFrom,
          indexTo : la.indexTo,
          items : []
        };
        for(var i = 0;i < la.items.length;i++){

          var kY = this.__dt(la.items[i], la.dataFlags);
          if(kY)kX.items.push(kY);
          qx.core.ObjectRegistry.unregister(kY);
        };
        kW(0, kX);
        return kX;
      },
      __dz : function(le, lc, ld){
        ...
        var lb = this.__dt(ld.item, ld.flags);
        qx.core.ObjectRegistry.unregister(lb);
        le((lb === null ? 6 : 0), lb);
        return lb;
      },
      __dA : function(lg, lf, lh){

        if(!lh){

          var li = this.getItem(lf);
          if(li){
  ...
  var gT = window.setInterval(function(){
    ...
    if(qx.$$loader.scriptLoaded){
      ...
      clearInterval(gT);
      var lk = eD;
      if(document.currentScript)lk = document.currentScript.src; else {

        var lm = document.getElementsByTagName(v);
        for(var i = 0;i < lm.length;i++)if(lm[i].src.search(ga) > 0 && lm[i].src.lastIndexOf(eF) >= 0){
      ...
      var ln = fS;
      var lj = new RegExp(ln);
      var ll = lj.exec(lk);
      if(ll != null && typeof window[ll[1]] == fJ)window[ll[1]]();
    };
  }, 50);
})();
(function(){
  ...
  qx.Class.define(cC, {
    ...
    statics : {
      ...
      registerProperties : function(){
        ...
        var eL = wialon.core.Session.getInstance();
        eL.registerConstructor(Q, wialon.item.Unit);
        eL.registerProperty(T, this.remoteUpdateUniqueId);
        eL.registerProperty(P, this.remoteUpdateUniqueId2);
        eL.registerProperty(H, this.remoteUpdateDeviceTypeId);
        eL.registerProperty(R, this.remoteUpdatePhoneNumber);
        eL.registerProperty(cF, this.remoteUpdatePhoneNumber2);
        eL.registerProperty(M, this.remoteUpdateAccessPassword);
        eL.registerProperty(cE, this.remoteUpdateCommands);
        eL.registerProperty(n, this.remoteUpdatePosition);
        eL.registerProperty(X, this.remoteUpdateLastMessage);
        eL.registerProperty(ds, this.remoteUpdateDriverCode);
        eL.registerProperty(O, this.remoteUpdateCalcFlags);
        eL.registerProperty(dg, this.remoteUpdateMileageCounter);
        eL.registerProperty(c, this.remoteUpdateEngineHoursCounter);
        eL.registerProperty(dB, this.remoteUpdateTrafficCounter);
        eL.registerProperty(cM, this.remoteUpdateMessageParams);
        eL.registerProperty(db, this.remoteUpdateNetConn);
        eL.registerProperty(G, this.remoteUpdateActive);
        eL.registerProperty(dj, this.remoteUpdateDeactivationTime);
        wialon.item.MIcon.registerIconProperties();
      },
      remoteUpdateUniqueId : function(eM, eN){

        eM.setUniqueId(eN);
      },
      remoteUpdateUniqueId2 : function(eO, eP){

        eO.setUniqueId2(eP);
      },
      remoteUpdateDeviceTypeId : function(eQ, eR){

        eQ.setDeviceTypeId(eR);
      },
      remoteUpdatePhoneNumber : function(eS, eT){

        eS.setPhoneNumber(eT);
      },
      remoteUpdatePhoneNumber2 : function(eU, eV){

        eU.setPhoneNumber2(eV);
      },
      remoteUpdateAccessPassword : function(eW, eX){

        eW.setAccessPassword(eX);
      },
      remoteUpdateCommands : function(eY, fa){
      ...
      remoteUpdateMessageParams : function(ft, fv){
        ...
        if(typeof fv != cO)return;
        var fs = ft.getMessageParams();
        if(!fs)fs = {
        }; else fs = qx.lang.Object.clone(fs);
        for(var fu in fv){

          if(typeof fv[fu] == cO && typeof fs[fu] == cO && fv[fu].ct > fs[fu].ct){

            var fw = fs[fu].at;
            fs[fu] = fv[fu];
            if(fw > fv[fu].at)fs[fu].at = fw;
          } else if(typeof fv[fu] == cO && typeof fs[fu] == dn)fs[fu] = fv[fu]; else if(typeof fs[fu] == cO && typeof fv[fu] == o && fv[fu] > fs[fu].at)fs[fu].at = fv[fu];;;
        };
      ...
      remoteUpdateActive : function(fz, fA){

        fz.setActivity(fA);
      },
      remoteUpdateDeactivationTime : function(fB, fC){

        fB.setDeactivationTime(fC);
      },
      checkHwConfig : function(fE, fD){
      ...
      getHwParams : function(fI, fH, fG, fF){
      ...
      __wI : function(fN, fM){
        ...
        if(!fM)return;
        var fL = wialon.core.Session.getInstance();
        var fK = fL.getLogger();
        if(!fK || (typeof fK.warn !== h))return;
        var fJ = (typeof fM.x === cQ) && (typeof fM.y === cQ);
        if(!fJ)return;
        fJ = (-90 <= fM.y && fM.y <= 90);
        if(!fJ){
